    ...
    <>
      ...
      <div className="visiMisi">
        ...
        <div className="visiMisi-right">
          ...
          <p className="typography-subtitle">{renderRichText(stuff.kontenVisiMisi, options)}</p>
        </div>
      </div>
        ...
        <div className="aktivitas-grid">
          <div className="gridImage">
            {stuff.kontentFotoAktivitas.map(item =>
              ...
              <div className="gridImage-item" style={{
      ...
      <div className="programStudi programStudi--1 typography--centerText">
        <div className="programStudi-head">
          ...
          <p className="typography-subtitle">{renderRichText(stuff.subtitleProgramStudi3Tahun, options)}</p>
        </div>
        <ul className="programStudi-list">
          <li className="programStudi-item">
            <div className="programStudi-bulet"><span className="programStudi-buletText">1</span></div>
            <div className="programStudi-content">
              <h3 className="programStudi-subtitle">Tahun Pertama</h3>
              <p className="programStudi-deskripsi">Belajar dan training sebagai Rank dan File di semua departement hotel</p>
            </div>
          </li>
          <li className="programStudi-item">
            <div className="programStudi-bulet"><span className="programStudi-buletText">2</span></div>
            <div className="programStudi-content">
              <h3 className="programStudi-subtitle">Tahun Kedua</h3>
              <p className="programStudi-deskripsi">Belajar dan training sebagai Supervisor di semua departement hotel</p>
            </div>
          </li>
          <li className="programStudi-item">
            <div className="programStudi-bulet"><span className="programStudi-buletText">3</span></div>
            <div className="programStudi-content">
              <h3 className="programStudi-subtitle">Tahun Ketiga</h3>
              <p className="programStudi-deskripsi">Belajar dan training sebagai Manager di semua departement hotel</p>
            </div>
          </li>
        </ul>
      </div>
      <div className="programStudi programStudi--2 typography--centerText">
        <div className="programStudi-head">
          ...
          <p className="typography-subtitle">Program Mingguan ditujukan untuk semua kalangan termasuk para pekerja di Industri perhotelan untuk meningkatkan skil, pengetahuan, dan berlatih bersama didalam workshop yang diadakan rutin pada setiap pertemuan.</p>
        </div>
        <ul className="programStudi-list">
          <li className="programStudi-item">
            <div className="programStudi-bulet"><span className="programStudi-buletText">1</span></div>
            <div className="programStudi-content">
              ...
              <p className="programStudi-deskripsi">Pengenalan tugas dari setiap posisi dalam sebuah departemen.</p>
            </div>
          </li>
          <li className="programStudi-item">
            <div className="programStudi-bulet"><span className="programStudi-buletText">2</span></div>
            <div className="programStudi-content">
              ...
              <p className="programStudi-deskripsi">Latihan dan praktek di lapangan.</p>
            </div>
          </li>
          <li className="programStudi-item">
            <div className="programStudi-bulet"><span className="programStudi-buletText">3</span></div>
      ...
      <div className="founder">
        <div className="founder-left"><img className="founder-img" src={stuff.kontenFotoFounder.file.url} alt={stuff.kontenFotoFounder.title} /></div>
        <div className="founder-right">
          <h2 className="typography-title">{stuff.judulFounder}</h2>
          <p className="typography-subtitle">{renderRichText(stuff.kontenFounder, options)}</p>
        </div>
      </div>
